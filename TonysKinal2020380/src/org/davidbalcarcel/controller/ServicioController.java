...
import org.davidbalcarcel.bean.Servicio;
...
public class ServicioController implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources){
        ...
        fecha.getStylesheets().add("/org/davidbalcarcel/resource/TonysKinal.css");
    ...
    public void guardar(){
        ...
        if(txtCodigoServicio == null || fecha.getSelectedDate() == null || txtTipoServicio.getText().isEmpty() || jpTime == null || txtLugarServicio.getText().isEmpty() || txtTelefonoContacto.getText().isEmpty() || cmbCodigoEmpresa.getSelectionModel().isEmpty()){
