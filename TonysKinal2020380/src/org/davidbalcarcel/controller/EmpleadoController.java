...
import org.davidbalcarcel.bean.Empleado;
import org.davidbalcarcel.bean.TipoEmpleado;
    ...
    public void nuevo(){
        switch(tipoDeOperacion){
            ...
            case GURDAR:
                    ...
                    imgNuevo.setImage(new Image("/org/davidbalcarcel/image/agregar-archivo.png"));
                    imgEliminar.setImage(new Image("/org/davidbalcarcel/image/boton-eliminar.png"));
    ...
    public void editar(){
        switch(tipoDeOperacion){
            ...
            case ACTUALIZAR:
                    ...
                    imgEditar.setImage(new Image("/org/davidbalcarcel/image/editar.png"));
                    imgReporte.setImage(new Image("/org/davidbalcarcel/image/reporte.png"));
                    tipoDeOperacion = operaciones.NINGUNO;
                    cargarDatos();
                break;
        }
